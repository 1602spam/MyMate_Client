...
namespace MainForm
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            d.PutUser(new MdlUser(1, "내이름은유저1번", "내이름은유저1번", "asdfd", "asd", "asd"));
            d.PutUser(new MdlUser(3, "내이름은유저3번", "내이름은유저3번", "asdfd", "asd", "asd"));
            d.PutUser(new MdlUser(4, "내이름은유저4번", "내이름은유저4번", "asdfd", "asd", "asd"));
            d.PutUser(new MdlUser(5, "내이름은유저5번", "내이름은유저5번", "asdfd", "asd", "asd"));
